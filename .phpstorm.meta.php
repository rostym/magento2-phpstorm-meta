...
namespace PHPSTORM_META {
    ...
    override(\Magento\Framework\Controller\ResultFactory::create(0),
        map([
    ...
    expectedArguments(\Magento\Framework\Controller\ResultFactory::create(), 0,
    ...
    registerArgumentsSet('condition_types',
        'eq', 'in', 'is', 'to', 'finset',
        'from', 'gt', 'gteq', 'like', 'lt',
        'lteq', 'moreq', 'neq', 'nin', 'notnull', 'null'
    );
    ...
    expectedArguments(\Magento\Framework\Api\SearchCriteriaBuilder::addSortOrder(), 0,
        \Magento\Framework\Api\SortOrder::SORT_ASC,
        \Magento\Framework\Api\SortOrder::SORT_DESC
    );

    registerArgumentsSet('scope_types',
    ...
    registerArgumentsSet('field_types',
        'button', 'checkbox', 'checkboxes', 'column', 'date',
        'editablemultiselect', 'editor', 'fieldset', 'file', 'gallery',
